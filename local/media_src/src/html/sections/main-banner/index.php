<div class="main-banner">
  <div class="swiper-container" data-slider="main-banner-slider">
    <div class="swiper-wrapper">
      <? for ($x = 0; $x <= 3; $x++): ?>
      <div class="swiper-slide main-banner__item" style="background-image: url(<?=MEDIA_PATH;?>images/home/banner-1.png)">
        <div class="container">
          <img class=" main-banner__item-logo" src="<?=MEDIA_PATH;?>images/home/banner-logo-1.svg" alt="logo">
