        ...
        <div class="package-info">
          ...
          <p class="mb-0 mb-1">
            ...
            <span class="package-info__contact">
              <svg>
                <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg#whatsapp"></use>
              </svg>  
        ...
        <div class="package-info">
          ...
          <ul class="package-info__list mb-2">
            <li>
              ...
              <img src="<?=MEDIA_PATH;?>images/pay-trio.png" alt="">
            </li>
            <li>
              <p class="mb-0">Оплата через банк Тинькофф</p>
              <img src="<?=MEDIA_PATH;?>images/tinkoff.png" alt="">
            </li>
            <li>
            ...
            <li>
              ...
              <svg>
                <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg#money"></use>
              </svg>  
            </li>
          </ul>
          <p class="mb-0">
