                  ...
                  <div class="row align-items-center g-1">
                    <div class="col-3 col-md-12">
                      <a href="<?=$homeFolder?>product.php" class="cart-info__product-photo">
                        <img src="<?=MEDIA_PATH;?>images/catalog/photo-<?=$i + 5?>.png?t=1692277951183" alt="product">
                      </a>
                    </div>
                ...
                <div class="col-md-8 my-auto mx-auto">
                  ...
                  <div class="cart-info__product-color">
                    ...
                    <div class="cart-info__product-color-pic">
                      <img src="<?=MEDIA_PATH;?>images/product/color-<?=$i?>.png?t=1692277951183" alt="color">
                    </div>
                  </div>
                ...
                <div class="quantity card__quantity" data-entity="basket-item-quantity-block">
                  ...
                  <button class="reset-btn minus quantity__minus" data-entity="basket-item-quantity-minus">
                    <svg class="svg-icon svg-icon--minus">
                      <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#minuse"></use>
                    </svg>
                  </button>
            ...
            <div class="cart-info-form">
              <form action="">
                ...
                <div class="cart-info-form__row">
                  <div class="d-flex align-items-center mb-2 mb-md-3">
                    <svg class="cart-info-icon">
                      <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#credit-card"></use>
                    </svg>
                ...
                <div class="cart-info-form__row">
                  <div class="d-flex align-items-center mb-2 mb-md-3">
                    <svg class="cart-info-icon">
                      <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#delivery-box"></use>
                    </svg>
                    <div class="z4 text-uppercase mb-0">
                      <span>доставка</span>
                    </div>
                ...
                <div class="cart-info-form__row">
                  <div class="d-flex align-items-center mb-2 mb-md-3">
                    <svg class="cart-info-icon">
                      <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#geo-marker"></use>
                    </svg>
                    <div class="z4 text-uppercase mb-0">
                  ...
                  <div class="row align-items-center justify-content-between g-1">
                    <div class="col-auto">
                      <label for="form-checkbox-7" class="d-flex align-items-center justify-content-between mb-0">
                        <svg class="cart-info-icon">
                          <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#gift"></use>
                        </svg>
                        <div class="z4 text-uppercase mb-0">
                    ...
                    <div class="col-auto ml-auto">
                      <a href="" class="d-flex pb-0">
                        <svg class="cart-info-icon">
                          <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#help-circle"></use>
                        </svg>
                      </a>
                    </div>
                    <div class="col-auto">
                  ...
                  <div class="row align-items-center justify-content-between g-1">
                    <div class="col-auto">
                      <label for="form-checkbox-8" class="d-flex align-items-center justify-content-between mb-0">
                        <svg class="cart-info-icon">
                          <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#write"></use>
                        </svg>
                        <div class="z4 text-uppercase mb-0">
