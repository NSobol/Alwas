            ...
            <? for ($i = 0; $i < 5; $i++): ?>
              <div class="swiper-slide">
                <div class="product-gallery__item">
                  <img src="<?=MEDIA_PATH;?>images/product/pic-<?= $i?>.png?t=1692277951183" alt="">
                </div>
              </div>
            <? endfor; ?>
          </div>
        ...
        <div class="product-asside__inner" data-sidebar="product-sidebar-inner">
          ...
          <div class="product-asside__types">
            ...
            <div class="product-asside__color">
              ...
              <div class="product-asside__color-type">
                <? for ($i = 0; $i < 2; $i++): ?>
                  <a href="#">
                    <img src="<?=MEDIA_PATH;?>images/product/color-<?= $i?>.png?t=1692277951183" alt="">
                  </a>
                <? endfor; ?>
              </div>
            </div>
            ...
            <div class="product-asside__info flex-wrap">
              <!-- <div class="product-asside__info-sizetable">
                <button class="d-none d-lg-inline-flex" data-filter="size-table">
                  <svg>
                    <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#ruler"></use>
                  </svg>
              ...
              <div class="product-asside__info-status">
                <span>
                  <span>В наличии</span>
                  <svg>
                    <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#check"></use>
                  </svg>
                </span>
              </div>
              <div class="row align-items-center flex-nowrap g-1 pt-1 pt-sm-0">
                <div class="col-auto d-flex align-items-center justify-content-center">
                  <svg width="20" height="16px">
                    <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#delivery-car"></use>
                  </svg>
                </div>
                <div class="col-auto">
                  ...
                  <div class="product-asside__filter-item">
                    <div class="row align-items-center justify-content-between">
                      <div class="col-auto d-flex align-items-center justify-content-between">
                        <svg>
                          <use xlink:href="<?=MEDIA_PATH;?>images/icons.svg?t=1692277951183#<?= $filterItem['icon'] ?>"></use>
                        </svg>
                        <div class="z4 mb-0">
          ...
          <div class="product-asside__help">
            ...
            <!-- <a href="" class="product-asside__help-item">
              <figure>
                <img src="<?=MEDIA_PATH;?>images/bow-small.png?t=1692277951183" alt="">
              </figure>
              <p>Записаться на консультацию в&nbsp;шоурум</p>
            </a> -->
            <a href="" class="product-asside__help-item">
            <figure>
                <img src="<?=MEDIA_PATH;?>images/package.png?t=1692277951183" alt="">
              </figure>
